...
int handle_mouse(int button, int x, int y, t_data *data)
{
    ...
    double zoom_level = 1.5;
    double mouse_x, mouse_y;

    mouse_x = (x - data->x_size / 2) / data->zoom + data->x_repos;
    mouse_y = (y - data->y_size / 2) / data->zoom + data->y_repos;
...
*/
    ...
    data->x_repos = mouse_x - (x - data->x_size / 2) / data->zoom;
    data->y_repos = mouse_y - (y - data->y_size / 2) / data->zoom;
...
/*
cc new2_fractol.c complex_plane.c utils.c -L minilibx-linux -lmlx -lXext -lX11 -lm -o fractol
*/